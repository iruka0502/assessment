...
function test(){
    ...
    console.log('同じ名前なら、同じ結果を出力することのテスト');
     ...
     console.log('次郎')
     console.assert(
        assessment('次郎') === assessment('次郎'),'入力が同じ名前なら同じ診断結果を出力する処理が正しくありません。'
     )     
     //太郎
     console.log('花子')
     console.assert(
        assessment('花子') === assessment('花子'),'入力が同じ名前なら同じ診断結果を出力する処理が正しくありません。'
     )
